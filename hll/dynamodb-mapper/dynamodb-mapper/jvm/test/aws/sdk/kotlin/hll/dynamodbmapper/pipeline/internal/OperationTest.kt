...
private fun HFooRequest.convert(table: String, schema: ItemSchema<Foo>) = LFooRequest(table, schema.converter.convertTo(foo))

private fun LFooResponse.convert(schema: ItemSchema<Foo>) = HFooResponse(schema.converter.convertFrom(foo))
