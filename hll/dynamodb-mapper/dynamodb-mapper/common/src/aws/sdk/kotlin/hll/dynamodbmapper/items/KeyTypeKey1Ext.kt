 ...
 */
public operator fun <K1> KeyType.Key1<K1>.invoke(value2: Byte): KeyType.Key2<K1, Byte> = KeyType2Impl(value1, value2)
 ...
 * @param value2 The value of the second attribute
 */
public operator fun <K1> KeyType.Key1<K1>.invoke(value2: Int): KeyType.Key2<K1, Int> = KeyType2Impl(value1, value2)
 ...
 * @param value2 The value of the second attribute
 */
public operator fun <K1> KeyType.Key1<K1>.invoke(value2: Long): KeyType.Key2<K1, Long> = KeyType2Impl(value1, value2)
 ...
 * @param value2 The value of the second attribute
 */
public operator fun <K1> KeyType.Key1<K1>.invoke(value2: Short): KeyType.Key2<K1, Short> = KeyType2Impl(value1, value2)
