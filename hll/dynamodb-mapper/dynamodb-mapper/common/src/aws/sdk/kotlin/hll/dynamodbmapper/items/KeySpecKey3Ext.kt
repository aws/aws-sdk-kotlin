 ...
 * @param name The name of the fourth attribute
 */
public fun <K1, K2, K3, N : Number> KeySpec.Key3<K1, K2, K3>.thenNumber(name: String): KeySpec.Key4<K1, K2, K3, N> = KeySpec4Impl(attr1, attr2, attr3, KeyAttrSpec.number(name))
