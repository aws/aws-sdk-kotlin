...
private val LONG_POLLING_OPERATIONS = setOf("GetActivityTask")

class SfnLongPollingIntegration : KotlinIntegration {
    override fun enabledForService(model: Model, settings: KotlinSettings): Boolean = model.expectShape(settings.service, ServiceShape::class.java).sdkId.lowercase() == "sfn"
